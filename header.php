...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Cousine:wght@400;700&family=Montserrat:wght@400;600;700&display=swap"
        rel="stylesheet">
    <title>
        <?php echo get_bloginfo("name"); ?> - <?php echo get_bloginfo(
                "description"
            ); ?>
    </title>
    <?php wp_head(); ?>
...
<body>
    <header class="nav-menu">
        <div class="nav-menu__menu">
            <img class="nav-menu__menu-logo" width="171" height="40" alt="Company's logo image" class="nav-menu__logo"
            ...
            <?php if (!empty($menu)): ?>
                ...
                <div id="nav-main-menu-items" class="nav-menu__menu-items">
                    <button id="nav-main-menu-button--close" class="nav-menu__menu-button nav-menu__menu-button--close"
